...
export class ApiclienteService {
  ...
  addClientes(cliente: Cliente): Observable<string> {
    return this._http.post<string>(this.url, cliente, httpOption);
  }
  editClientes(cliente: Cliente): Observable<string> {
    return this._http.put<string>(this.url, cliente, httpOption);
  }
